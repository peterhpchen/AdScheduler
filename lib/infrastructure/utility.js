...
utility.getSelectedDate = function (answers) {
    ...
    if (week === 'weekday') return utility.getDateByDayOfWeek(startDate, endDate, weekday);
    if (week === 'weekend') return utility.getDateByDayOfWeek(startDate, endDate, weekend);
    if (week === 'specificDay') return utility.getDateByDayOfWeek(startDate, endDate, answers.playDay);
